...
class Stores:
    ...
    def __init__(self, store_name="", store_address="", store_zipcode="",store_hours=[], store_items=[], store_sale_items=[], 
                 sales_promotions_start_date="", sales_promotions_end_date="", store_favorites=[],store_id=None):
    ...
    def to_json(self):
        return{"store_name": self.store_name,
                ...
                "self.store_favorites": self.store_favorites,
